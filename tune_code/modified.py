...
def calculate_sum_Y_terms(z0, z1, z2, x20, th20, x20b, th20b, x21, th21, x21b, th21b):
    """
    Computes sum_Y_terms with XLA JIT compilation enabled.
...
def GNLOT(Q, beta, z0, z1, x20, th20, x20b, th20b, x21, th21, x21b, th21b):
    ...
    kin_factor = z0 * z1 * calculate_sum_Y_terms(z0, z1, z2, x20, th20, x20b, th20b, x21, th21, x21b, th21b)
